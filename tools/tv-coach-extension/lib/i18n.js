...
(function () {
  ...
  var STRINGS = {
    fr: {
      ...
      'banner.token_expired': 'Session expirée — reconnecte-toi sur omenserver.org.',
      ...
      'options.token_hint': 'Le bouton « Connecter » sur omenserver.org le remplit tout seul.',
    ...
    it: {
      ...
      'banner.token_expired': 'Sessione scaduta — riconnettiti su omenserver.org.',
      ...
      'options.token_hint': 'Il pulsante « Collega » su omenserver.org lo riempie da solo.',
      'options.save': 'Salva',
    ...
    en: {
      ...
      'banner.token_expired': 'Session expired — sign in again on omenserver.org.',
      ...
      'options.token_hint': 'The "Connect" button on omenserver.org fills it in for you.',
      'options.save': 'Save',
      'options.saved': 'Saved.',
